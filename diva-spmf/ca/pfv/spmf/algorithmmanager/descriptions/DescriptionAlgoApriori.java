...
public class DescriptionAlgoApriori extends DescriptionOfAlgorithm {
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/index.php?link=documentation.php#example1";
	}
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		ca.pfv.spmf.algorithms.frequentpatterns.apriori.AlgoApriori algorithm = new ca.pfv.spmf.algorithms.frequentpatterns.apriori.AlgoApriori();
