...
public class FPTree {
	...
	public void createHeaderList(final Map<Integer, Integer> mapSupport) {
		...
		setHeaderList(new ArrayList<Integer>(mapItemNodes.keySet()));
		
		// sort the header table by decreasing order of support
		Collections.sort(getHeaderList(), new Comparator<Integer>(){
	...
	public void setHeaderList(List<Integer> headerList) {
