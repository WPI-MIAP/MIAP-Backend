...
//			Set<Integer> alreadySeen = new HashSet<Integer>();
	 ...
	 */
	protected void fpgrowth(FPTree tree, int [] prefix, int prefixLength, int prefixSupport, Map<Integer, Integer> mapSupport) throws IOException {
...
//		System.out.println(tree);
		...
		if(singlePath && singlePathSupport >= minSupportRelative){	
			...
			for(int i = tree.getHeaderList().size()-1; i>=0; i--){
				// get the item
				Integer item = tree.getHeaderList().get(i);
